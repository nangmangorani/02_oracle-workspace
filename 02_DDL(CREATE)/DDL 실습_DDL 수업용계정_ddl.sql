...
INSERT INTO TB_MEMBER VALUES (1,'zzz123', '1233', '강주원', 'M', '서울시 여러분 담배꽁초', '010-1122-2233','N','12/12/12');
INSERT INTO TB_MEMBER VALUES (1,'nasunuk99', '999', '아는형님', 'F', '제주도', '010-1212-1212','N',DEFAULT);
INSERT INTO TB_MEMBER VALUES (1,'zlzl', '111', '강아지', 'F', NULL, NULL,'Y','20/12/11');
INSERT INTO TB_MEMBER VALUES (1,'lier13', '123', '김구라', 'M', '구라동', null,'N',DEFAULT);

-- 4.

CREATE TABLE TB_RENT(
    RENT_NO NUMBER CONSTRAINT RENT_PK PRIMARY KEY,
    RENT_MEM_NO NUMBER CONSTRAINT RENT_FK_MEM-- 외래키, 부모데이터 삭제시 null값되도록
    RENT_BOOK_NO, -- 외래키, 부모데이터 삭제시 null값되도록
